...
import { registerMilestone4Routes } from "./milestone4.js";
import { registerMilestone5Routes } from "./milestone5.js";
...
import { registerMilestone10Routes } from "./milestone10.js";
...
export async function registerGatewayRoutes(app: FastifyInstance, deps: GatewayDependencies) {
  ...
  await registerMilestone4Routes(app, deps);
  await registerMilestone5Routes(app, deps);
  ...
  await registerMilestone10Routes(app, deps);
}
